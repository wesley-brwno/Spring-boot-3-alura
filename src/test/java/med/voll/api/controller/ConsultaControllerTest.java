...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DadosAgendamentoConsulta> dadosAgendamentoConsutaJson;
    @Autowired
    ...
    void agendar_cenario1() throws Exception {
        ...
        response = mockMvc.perform(post("/consultas")
                        .content(requestBody)
    ...
    @Test
    @DisplayName("Deveria devolver código http 200 quando dados são válidos")
    @WithMockUser
    void agendar_cenario2() throws Exception {
        ...
        response = mockMvc.perform(post("/consultas")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(dadosAgendamentoConsutaJson.write(
